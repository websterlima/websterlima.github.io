const Hero = () => {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center bg-gradient-to-br from-purple-50 to-blue-50"
    >
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Passionate about innovation and impactful technology solutions.
                I drive data-driven decisions and create smarter tech solutions

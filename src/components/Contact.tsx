              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:websterhlima@gmail.com" className="text-purple-600 hover:text-purple-700">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a href="https://github.com/websterlima" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:text-purple-700">
